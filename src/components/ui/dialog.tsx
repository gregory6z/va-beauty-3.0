...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-zinc-900/60  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className,
    )}
    {...props}
  />
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        onChange={(open) => setIsOpen(Boolean(open))}
        ref={ref}
        className={cn(
