...
export const CommentsHomeSecondPart = [
  {
  ...
  {
    name: "Natacha Alves",
    content: `La micropigmentation des lèvres réalisée par Valesca était juste incroyable ! Mes lèvres ont maintenant une teinte plus rosée et naturelle, et je suis vraiment ravie du résultat. Valesca est une véritable experte dans son domaine, et sa capacité à sublimer la beauté naturelle est remarquable. J'ai hâte de montrer mes nouvelles lèvres partout où je vais !`,
    image: "/natacha.png",
  },
]
