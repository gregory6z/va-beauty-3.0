...
export function ServiceCard({
  ...
  return (
    <main className=" flex h-full w-full flex-col rounded-sm border border-gray-200 bg-white     sm:grid-cols-2 lg:mx-0  lg:max-w-[1080px]    lg:flex-row  lg:gap-10 lg:p-8">
