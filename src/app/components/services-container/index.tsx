...
export async function ServicesContainer({ category }: ServiceProps) {
  ...
  return (
    <Suspense fallback={<p>Loading</p>}>
      <div className="mx-auto mt-6 px-[1.5rem] lg:mt-10 lg:max-w-[1080px]   lg:px-[0] xl:max-w-[1080px]">
        <BreadcrumbService />
      </div>
      <article className="mx-auto flex max-w-[1080px] flex-col gap-4 px-[1.5rem] pb-6  pt-12 lg:flex-row lg:gap-10 lg:px-0 lg:pb-14">
      ...
      <main className="mt-[2rem] flex h-full w-full flex-col items-center gap-8 px-[1rem] pb-[5rem] sm:mx-auto sm:max-w-[600px] lg:mx-auto lg:mt-[3rem] lg:max-w-[1216px] lg:px-[0] lg:pb-[8rem] xl:max-w-[1256px]">
