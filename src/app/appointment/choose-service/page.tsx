    ...
    <>
      ...
      <div className="h-full min-h-screen w-full bg-zinc-200">
        <div className="lg:max-w--[1216px] flex flex-col lg:mx-auto lg:px-[2rem] xl:max-w-[1256px] ">
          <div className=" sticky top-[4rem] z-10 mb-4 overflow-auto bg-zinc-200 lg:top-[5rem]  ">
            <ProgressIndicator currentStep={1}></ProgressIndicator>
          </div>

          <div className="gap-8 lg:grid lg:grid-cols-5 ">
            <div className="col-span-3">
              <header className=" sticky top-[7.5rem] z-10 flex flex-col gap-1  bg-zinc-200 px-[1.5rem] lg:top-[9rem] lg:px-0">
